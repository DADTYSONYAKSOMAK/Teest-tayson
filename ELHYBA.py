...
#حقوق تايسون @H1HHIH - @T_T_1T_T_T
# تطوير تايسون برسفور  @T_T_1T_T_T - @SOU_RCE_R3D 
ownerID = int("6094482545") #ايدي الادمن 
api_hash = Config.("52e91180e35e6d91898764b43c567493") #ايبي هاش 
api_id = Config.APP_ID( "21793031")           #ايبي ايدي
token = Config.("6780800967:AAGtzRumWRr7bBy8lIonOUF7oZi2Tz8xW"-s) #البوت


bot = Client(
  'bot'+token.split(":")[0],
  21793031, #ايبي ايدي
 '52e91180e35e6d91898764b43c567493', #ايبي هاش
...
app.start()
bot.start()
print("تم تشغيل البوت @T_T_1T_T_T")
idle()
